...
async function test() {
  console.log('=== Testing audio-transcriber-moonshine-tiny-int8 (with Silero VAD v4 + Moonshine Tiny int8) ===\n');
  ...
  console.log('\n=== Test completed for audio-transcriber-moonshine-tiny-int8 ===');
}
