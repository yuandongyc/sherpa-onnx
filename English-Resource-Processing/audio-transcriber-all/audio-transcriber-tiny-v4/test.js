...
const config = {
  whisper: {
    encoder: 'D:/MyProjects/c_projects/sherpa-onnx/all_models/sherpa-onnx-whisper-tiny.en/tiny.en-encoder.onnx',
    decoder: 'D:/MyProjects/c_projects/sherpa-onnx/all_models/sherpa-onnx-whisper-tiny.en/tiny.en-decoder.onnx',
...
async function test() {
  console.log('=== Testing audio-transcriber-tiny-v4 (with Silero VAD v4) ===\n');
  ...
  console.log('\n=== Test completed for audio-transcriber-tiny-v4 ===');
}
