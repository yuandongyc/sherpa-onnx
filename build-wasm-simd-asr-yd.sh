...
#
# This script is to build sherpa-onnx for WebAssembly (ASR-YD)
...
mkdir -p build-wasm-simd-asr-yd
pushd build-wasm-simd-asr-yd
...
# 只构建 asr-yd 目标
make sherpa-onnx-wasm-main-asr-yd -j2
make install

ls -lh install/bin/wasm/asr-yd
